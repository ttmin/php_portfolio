  ...
  <div id="content">
		...
		<?php foreach ($posts as $post): ?>
			...
			<p><?php echo makeLink(h($post['message'])); ?><span class="name">（<?php echo h($post['name']); ?>）</span>
				[<a href="index2.php?res=<?php echo h($post['id']); ?>">Re</a>]</p>
		...
		<ul class="paging">
			<?php if ($page > 1): ?>
				<li><a href="index2.php?page=<?php echo ($page-1); ?>">前のページへ</a></li>
			<?php eise: ?>
				<li>前のページへ</li>
			<?php endif; ?>

			<?php if ($page < $maxPage): ?>
				<li><a href="index2.php?page=<?php echo ($page+1); ?>">次のページへ</a></li>
			<?php else: ?>
				<li>次のページへ</li>
			<?php endif; ?>
		</ul>
